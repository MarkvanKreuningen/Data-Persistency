...
from medewerkers m
where not (m.naam = 'JANSEN' and m.voorl = 'R');
...
INSERT into medewerkers values (8002, 'VAN DER POEL', 'J', 'STAGIAIR', 7902, '12-09-1999', 700.00, NULL, 30)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
INSERT INTO SCHALEN values (6, 3001.00, 4000.00, 500.00)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into uitvoeringen values ('D&P', '2022-02-01', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into uitvoeringen values ('D&P', '2022-09-01', 7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into inschrijvingen values (7876, 'D&P', '2022-09-01', 3)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into inschrijvingen values (7788, 'D&P', '2022-02-01', 3)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into inschrijvingen values (7698, 'D&P', '2022-02-01', 3)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
where functie = 'VERKOPER' and afd = '30';
...
-- Dit komt omdat alders nog ingeschreven staat bij meerdere cursussen
...
INSERT into medewerkers values (8001, 'KREUNINGEN', 'M', 'TESTER', 7839, '12-09-1998', 2800.00, NULL, 30)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT into afdelingen values (50, 'FINANCIEN', 'LEERDAM', 8001)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
VALUES 	(7654, 2019, '2019-01-01', '2019-10-15', 30, 1100.00, 'Senior verkoper; zou wel eens een aanwinst kunnen zijn?'),
          (7654, 2019, '2019-10-15', null, 30, 1250.00, 'Valt toch een beetje tegen.');
